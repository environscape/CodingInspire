...
*   每个CV接口 都可以设置为4种类型, 每个CV接口都可以指定该信息的MIDI通道(为1-16)
...
*   以上信息您需要使用 "四"使用助手来修改您模块的映射配置，您也可以在购买时让商家协助您配置。
*   NOTE_NUMBER NOTE_ON_OFF NOTE_VEL 需要设置第三个参数来进行关联绑定(0-64的数字，当一样时，被认为是一组信息)，这样就可以确定是哪一个NOTE_NUMBER与NOTE_ON_OFF NOTE_VEL是相关的了 
*   
